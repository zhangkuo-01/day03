...
insert  into `device_type`(`device_type_id`,`type_name`,`status`,`createtime`) values (1,'Android_Phone',NULL,NULL),(2,'Android_Pad',NULL,NULL),(3,'IOS_Phone',NULL,NULL),(4,'IOS_Pad',NULL,NULL);
...
CREATE TABLE `log` (
  ...
  PRIMARY KEY (`logId`)
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='操作日志记录';

/*Data for the table `log` */

insert  into `log`(`logId`,`userName`,`createTime`,`content`,`operation`,`ip`,`module`) values (1,'test','2017-11-29 14:31:04',NULL,'退出',NULL,NULL),(2,'test','2017-11-29 14:31:14',NULL,'登录','192.168.1.17',NULL),(3,'admin','2020-07-31 19:48:00',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(4,'admin','2020-07-31 19:48:00',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(5,'admin','2020-08-02 15:47:17',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(6,'admin','2020-08-02 15:47:17',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(7,'admin','2020-08-02 19:21:11',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(8,'admin','2020-08-02 19:39:31',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(9,'admin','2020-08-02 19:39:31',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(10,'admin','2020-08-02 20:22:29',NULL,'登录','0:0:0:0:0:0:0:1',NULL),(11,'admin','2020-08-02 20:22:29',NULL,'登录','0:0:0:0:0:0:0:1',NULL);
...
/*Table structure for table `td_device` */

DROP TABLE IF EXISTS `td_device`;

CREATE TABLE `td_device` (
...
/*Data for the table `td_device` */

insert  into `td_device`(`deviceId`,`device_type`,`device_name`,`device_ram`,`color`,`price`,`status`,`createtime`) values (2,1,'华为Pad','64G','金色',3000,'启用','2020-08-02 19:21:30'),(3,2,'华为p30','64G','金色',3000,'禁用','2020-08-02 19:21:47');
